...
<body>
  ...
  <main>
    ...
    <hr>
    <p style="text-align:center;">Escolha um quarto primeiro</p>
    <div class="botao" style="display:flex;justify-content:center;width:auto;">
      <a href="{{route('rooms')}}" class="btn btn-primary button-reserve" style="width: 20%;font-family:'Poppins';">Quartos</a>
    </div>
